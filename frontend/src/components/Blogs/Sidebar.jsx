...
export default function Sidebar() {
  ...
  if (categoriesLoading || popularBlogsLoading) return <div className="p-8 text-center text-gray-500 animate-pulse">Blog alani yukleniyor...</div>;
