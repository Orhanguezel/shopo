...
import LayoutHomeThree from "@/components/Partials/LayoutHomeThree";
import SectionStyleOneHmThree from "@/components/Helpers/SectionStyleOneHmThree";
  ...
  return (
    <>
      <LayoutHomeThree type={3} childrenClasses="pt-0">
        ...
        <SectionStyleOneHmThree
          type={3}
          categoryBackground={`${import.meta.env.VITE_PUBLIC_URL
